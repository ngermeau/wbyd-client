  ...
  return (
    <div>
      <p className="p-3 text-text text-lg sm:text-base">
        ...
        same kind of taste and think of any worthwhile addition to this list, please feel free to <a className="underline" href="https://github.com/ngermeau/wbyd-client/issues/new">send a request.</a>
      </p>
      <p className="p-3">
        Made with <img className="w-5 inline-block m-1" src={heart} /> on
        <a href="https://github.com/ngermeau/wbyd-client" target="_blank" rel="noreferrer noopener">
